...
import { Users as UsersIcon, Shield, Activity, Mail, Calendar, MoreVertical, Search, Filter } from 'lucide-react'
import { useUsers } from '../hooks/useUsers'

function Users({ user }) {
  const { users, stats, roles, loading, error, createUser, updateUser, deleteUser, getUserDetails, updateFilters, refreshData } = useUsers()
