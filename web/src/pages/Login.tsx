...
function Login({ onLogin }: { onLogin?: any }) {
  ...
  const getEnvironmentSpecificData = (envType: any) => {
    const environments = {
      development: {
        userIdBase: 1000,
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e: any) => setCredentials({ ...credentials, username: sanitizeInput(e.target.value) })}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e: any) => setCredentials({ ...credentials, password: sanitizeInput(e.target.value) })}
