...
export const blockchainAPI = {
  ...
  // Add audit log
  addAuditLog: async (logData: Record<string, any>): Promise<any> => {
  ...
  // Get block details
  getBlockDetails: async (blockId: string): Promise<any> => {
    return await API_CONFIG.request(`/blockchain/blocks/${blockId}`)
  },

  // Get transaction details
  getTransactionDetails: async (txId: string): Promise<any> => {
