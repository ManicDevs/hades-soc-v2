...
// =============================================================================
// SQLite Audit Log Repository Implementation (Pure Go - No CGO)
// =============================================================================

// sqliteAuditLogRepository implements AuditLogRepository for SQLite
type sqliteAuditLogRepository struct {
	db *sql.DB
}

// NewSQLiteAuditLogRepository creates a new SQLite audit log repository
func NewSQLiteAuditLogRepository(db *sql.DB) *sqliteAuditLogRepository {
	return &sqliteAuditLogRepository{db: db}
}

// Create inserts a new audit log entry
func (r *sqliteAuditLogRepository) Create(ctx context.Context, log *AuditLog) error {
	query := `
...
func (r *sqliteAuditLogRepository) GetByID(ctx context.Context, id int) (*AuditLog, error) {
	query := `
...
func (r *sqliteAuditLogRepository) List(ctx context.Context, filter AuditLogFilter) ([]*AuditLog, error) {
...
func (r *sqliteAuditLogRepository) Count(ctx context.Context, filter AuditLogFilter) (int, error) {
...
func (r *sqliteAuditLogRepository) GetByUserID(ctx context.Context, userID int, limit int) ([]*AuditLog, error) {
	return r.List(ctx, AuditLogFilter{UserID: userID, Limit: limit})
}

// GetByAction retrieves audit logs by action type
func (r *sqliteAuditLogRepository) GetByAction(ctx context.Context, action string, limit int) ([]*AuditLog, error) {
	return r.List(ctx, AuditLogFilter{Action: action, Limit: limit})
}

// DeleteOlder deletes audit logs older than the specified date
func (r *sqliteAuditLogRepository) DeleteOlder(ctx context.Context, date time.Time) (int64, error) {
...
func (r *sqliteAuditLogRepository) Ping(ctx context.Context) error {
	return r.db.PingContext(ctx)
}

// Close closes the repository and releases resources
func (r *sqliteAuditLogRepository) Close() error {
	return r.db.Close()
}

// buildSelectQuery builds the SELECT query with filters (SQLite uses ? placeholders)
func (r *sqliteAuditLogRepository) buildSelectQuery(filter AuditLogFilter) (string, []interface{}) {
...
func (r *sqliteAuditLogRepository) buildCountQuery(filter AuditLogFilter) (string, []interface{}) {
	var conditions []string
	var args []interface{}
