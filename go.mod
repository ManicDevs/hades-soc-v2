...
replace gitlab.torproject.org/cerberus-droid/torgo => ./build/run/torgo
...
require (
	...
	gitlab.torproject.org/cerberus-droid/torgo v0.0.0-00010101000000-000000000000
	golang.org/x/crypto v0.50.0 // direct
	gopkg.in/yaml.v3 v3.0.1 // direct
	modernc.org/sqlite v1.50.0 // direct - pure Go SQLite (no CGO)
)
